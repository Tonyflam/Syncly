...
export type ChatDetailsFailure = FailedAuthentication | DirectChatUnsupported | NotAuthorized | NotFound | ServerError;
export type DeleteChannelSuccess = {
    kind: "success";
};
export type DeleteChannelFailure = ChannelNotFound | FailedAuthentication | InvalidRequest | NotAuthorized | Frozen | ServerError;
export type CreateChannelSuccess = {
    kind: "success";
    channelId: number;
};
export type CreateChannelFailure = FailedAuthentication | InvalidRequest | NotAuthorized | Frozen | ServerError;
export type SendMessageFailure = FailedAuthentication | InvalidRequest | NotAuthorized | Frozen | ThreadNotFound | MessageAlreadyFinalized | ServerError;
...
export type DirectChatUnsupported = {
    kind: "direct_chat_unsupported";
};
...
export type MessageAlreadyFinalized = {
    kind: "message_already_finalized";
};
