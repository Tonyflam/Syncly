...
export type LeafGate = NeuronGate | PaymentGate | DiamondGate | LifetimeDiamondGate | NftGate | CredentialGate | TokenBalanceGate | UniquePersonGate | LockedGate | ReferredByMemberGate;
